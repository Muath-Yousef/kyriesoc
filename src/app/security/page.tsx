      ...
      <div className="container mx-auto px-6 relative z-10 max-w-4xl">
        ...
        <div className="space-y-12">
          ...
          <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }}>
            <h2 className="text-2xl font-bold text-emerald-400 mb-4">Reporting a Vulnerability</h2>
            <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl text-neutral-300 leading-relaxed text-sm">
              ...
              <ul className="list-disc pl-5 space-y-2 text-neutral-400">
                <li>Submit your report via our <Link href="/contact" className="text-emerald-400 hover:underline">Contact Page</Link>.</li>
          ...
          <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-5 bg-white/[0.02] border border-white/5 rounded-2xl">
                <h3 className="font-bold text-emerald-400 mb-2">Fast Response</h3>
                <p className="text-sm text-neutral-400">We aim to acknowledge receipt of vulnerability reports within 24 hours.</p>
              </div>
              <div className="p-5 bg-white/[0.02] border border-white/5 rounded-2xl">
                <h3 className="font-bold text-emerald-400 mb-2">Safe Harbor</h3>
              ...
              <div className="p-5 bg-white/[0.02] border border-white/5 rounded-2xl">
                <h3 className="font-bold text-emerald-400 mb-2">Transparency</h3>
              ...
              <div className="p-5 bg-white/[0.02] border border-white/5 rounded-2xl">
                <h3 className="font-bold text-emerald-400 mb-2">Remediation</h3>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="mt-16 text-center bg-emerald-500/10 border border-emerald-500/20 p-10 rounded-3xl">
            ...
            <Link href="/contact" className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-black px-8 py-4 rounded-xl font-bold transition-all shadow-[0_0_20px_rgba(16,185,129,0.2)]">
